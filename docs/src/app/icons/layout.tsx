...
import {JalaBiomass, JalaCoin, JalaHome} from "@jala-banyu/icons";

export const metadata: Metadata = {
    title: "Banyu icons",
    description: "Banyu icons is an icon library designed for the react project by Banyu UI, provided to help develop the JALA Web App",
};
        ...
        <>
            <header className="sticky top-0 z-50 flex items-center justify-between px-3 py-2 border-b shadow-lg bg-white/90 backdrop-blur-sm border-slate-400/40">
                ...
                <div className="items-center justify-end flex-grow hidden basis-0 md:flex">
                    <Button radius="lg">
                       <JalaHome className="text-white"/> Go to homepage
                    </Button>
