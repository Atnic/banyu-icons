...
const SvgReminder = ({ title, titleId, ...props }) => (
  <svg
  ...
  >
    ...
    <path d="M17.876 6.876a8.383 8.383 0 0 1 1.901 2.627 3.229 3.229 0 0 0 .98-3.756 3.226 3.226 0 0 0-5.646-.59 8.364 8.364 0 0 1 2.765 1.72M4.374 9.617A3.225 3.225 0 1 1 8.93 5.22a8.434 8.434 0 0 0-4.556 4.396" />
    <path
      fillRule="evenodd"
