...
const SvgFarmStep = ({ title, titleId, ...props }) => (
  ...
  >
    ...
    <path d="M8.046 18.043H3V3.75h12.036v4.44H9.295a1.256 1.256 0 0 0-1.173.827H5.003v.5h3.043v2.508h-3.04v.502h3.04v2.509h-3.04v.501h3.04zM5.006 6.007v.502h8.36v-.502z" />
